...
#ifndef __S3_SERVER_S3_GET_BUCKET_ACTION_VERSIONS_H__
#define __S3_SERVER_S3_GET_BUCKET_ACTION_VERSIONS_H__
...
class S3GetBucketVersionAction : public S3BucketAction {
 ...
 protected:
  std::shared_ptr<S3ObjectVersionListResponse> object_list;
 ...
 public:
  ...
  void get_next_object_version();
  void get_next_object_version_successful();
  void get_next_object_version_failed();
  ...
  /*
    ...
    FRIEND_TEST(S3GetBucketActionTest,
    GetNextObjectsSuccessfulDelimiterLastKey);
    */
};
