...
int s3_addb_init() {
  ...
  gs_addb_map[std::type_index(typeid(S3GetBucketVersionAction))] =
      S3_ADDB_S3_GET_BUCKET_VERSION_ACTION_ID;
  ...
  s3_log(S3_LOG_DEBUG, "",
         "  * id 0x%" PRIx64 "/%" PRId64  // suppress clang warning
         ": class S3GetBucketVersionAction\n",
         (uint64_t)S3_ADDB_S3_GET_BUCKET_VERSION_ACTION_ID,
         (int64_t)S3_ADDB_S3_GET_BUCKET_VERSION_ACTION_ID);
