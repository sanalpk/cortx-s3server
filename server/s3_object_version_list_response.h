...
#ifndef __S3_SERVER_S3_OBJECT_VERSION_LIST_RESPONSE_H__
#define __S3_SERVER_S3_OBJECT_VERSION_LIST_RESPONSE_H__
...
class S3ObjectVersionListResponse {
 ...
 public:
  S3ObjectVersionListResponse(const std::string& encoding_type = "");
  ...
  /*  // Google tests.
    ...
    FRIEND_TEST(S3ObjectVersionListResponseTest,
    ObjectListResponseConstructorTest);
    FRIEND_TEST(S3ObjectVersionListResponseTest,
    TestS3ObjectVersionListResponseSetters);
    FRIEND_TEST(S3ObjectVersionListResponseTest,
    TestS3ObjectVersionListResponseGetters);
    FRIEND_TEST(S3ObjectVersionListResponseTest,
